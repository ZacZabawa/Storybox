...
@section('content')
<div  class="container" class='dropzoneStyle'>
<h3>Media Upload <span id="photoCounter"></span></h3>
                <br />
...
@include("partials.addMediaForm")
 ...
 <div class="jumbotron how-to-create">
                <ul>
                    <li>Only upload media attributed to the selected contributor</li>
                    
                    <li>Maximum allowed size of image is 200MB</li>
                    <li>Images are uploaded once you press submit</li>
                </ul>
