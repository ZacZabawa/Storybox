...
$cAccessDeniedErrorSuggestions='<p>You do not have permission to access this page. This could be due to one of several reasons:</p><ol> <li>You are not logged in. Go to <a class="alert-link" href="%s">login page</a> and try again.</li> <li>You may not have sufficient privileges to execute operations.</li> </ol>';
...
$cPageSettings='Page settings';
$cAppearance='Appearance';
$cViewMode='View mode';
$cCardViewMode='Cards';
$cTableViewMode='Grid';
$cCardRowCount='Number of cards in a row';
$cView='View';
$cEdit='Edit';
$cCopy='Copy';
$cKeepImage='Keep';
...
$cChangePageSizeTitle='Page size';
...
$cisNotBlank='Is not blank';
$cNone='None';
$cCreateFilterConditionFirst='To display data, <a href="#" class="js-filter-builder-open">open Filter Builder</a> and specify one or more conditions.';
$cCreateFilter='Create filter';
$cEditFilter='Edit filter';
...
$cOperatorOr='Any';
$cOperatorNone='None';
$cOperatorStringAnd='And';
$cOperatorStringOr='Or';
$cOperatorStringNone='Not';

$cLoading='Loading';
$cFilterBuilder='Filter builder';
$cFilterBuilderGroupConditionBeforeRules='Select records where';
$cFilterBuilderGroupConditionAfterRules='of the following apply';
$cDeleteSelectedRecordsQuestion='Delete selected records?';

$cAddGroup='Add group';
$cAddCondition='Add condition';
$cRemoveGroup='Remove group';
$cRemoveCondition='Remove condition';
$cEnableFilter='Enable filter';
$cDisableFilter='Disable filter';
...
$cFilterOperatorIsBetweenShort           = 'Is between';
$cFilterOperatorIsNotBetween             = 'Is not between';
$cFilterOperatorIsNotBetweenShort        = 'Is not between';
$cFilterOperatorContains                 = 'Contains';
$cFilterOperatorContainsShort            = 'Contains';
$cFilterOperatorDoesNotContain           = 'Does not contain';
$cFilterOperatorDoesNotContainShort      = 'Does not contain';
$cFilterOperatorBeginsWith               = 'Begins with';
$cFilterOperatorBeginsWithShort          = 'Begins with';
$cFilterOperatorEndsWith                 = 'Ends with';
$cFilterOperatorEndsWithShort            = 'Ends with';
$cFilterOperatorIsLike                   = 'Is like';
$cFilterOperatorIsLikeShort              = 'Is like';
$cFilterOperatorIsNotLike                = 'Is not like';
$cFilterOperatorIsNotLikeShort           = 'Is not like';
$cFilterOperatorIsBlank='Is blank';
$cFilterOperatorIsBlankShort='is blank';
$cFilterOperatorIsNotBlank='Is not blank';
...
$cMultipleColumnSorting='Multiple Sort';
$cColumn='Column';
$cOrder='Order';
$cSort='Sort';
$cAddLevel='Add level';
...
$cCalendarMonths="January_February_March_April_May_June_July_August_September_October_November_December";
$cCalendarMonthsShort="Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec";
$cCalendarWeekdays="Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday";
$cCalendarWeekdaysShort="Sun_Mon_Tue_Wed_Thu_Fri_Sat";
$cCalendarWeekdaysMin="Su_Mo_Tu_We_Th_Fr_Sa";

$cDeleteUserConfirmation='User \"%s\" will be deleted. Are you sure?';

$cToggleDetails = 'Show/hide details';
$cToggleAllDetails = 'Show/hide all details';
$cGoToMasterDetailPage = 'Go to master/detail page';
