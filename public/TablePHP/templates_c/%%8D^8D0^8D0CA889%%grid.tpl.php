...
unset($_smarty_tpl_vars);
 ?>
    ...
    <?php if (! $this->_tpl_vars['Grid']['ErrorMessage'] == ''): ?>
        <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'common/error_message.tpl', 'smarty_include_vars' => array('dismissable' => true,'caption' => $this->_tpl_vars['Captions']->GetMessageString('ErrorsDuringInsertProcess'),'content' => $this->_tpl_vars['Grid']['ErrorMessage'])));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    <?php endif; ?>
